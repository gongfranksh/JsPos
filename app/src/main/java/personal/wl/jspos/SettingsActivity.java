...
public class SettingsActivity extends PreferenceActivity {
    ...
    private int pref_headers;
    private int pref_general;
...
/*
        ...
        EditTextPreference pos_machine = findPreference()
...
*/
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || PesonPreferenceFragment.class.getName().equals(fragmentName)
...
*/
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class PesonPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
